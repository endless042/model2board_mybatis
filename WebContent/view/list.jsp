...
<body>
 <p class="w3-left" style="padding-left:30px;">
    ...
    <div class="w3-container">
       ...
       <a href="<%=request.getContextPath()%>/board/writeFormUpload">글쓰기</a>
       </p>
       ...
       <c:forEach var="article" items="${articleList}">
          ...
          <c:if test="${article.re_level>0}">
             ...
             <img src="../images/re.gif">
                ...
                <img src="../images/level.gif" height="16"></c:if>
                
               <a href="<%=request.getContextPath()%>/board/content?num=${article.num}&pageNum=${currentPage}">
                ${article.subject}</a>
                 <c:if test="article.readconut>=20">
